...
ARG NODEBB_BUILD_PLUGINLIST="nodebb-plugin-s3-uploads-updated@0.3.13 nodebb-plugin-gravatar@2.0.4 nodebb-plugin-topic-tags@0.1.3  nodebb-plugin-question-and-answer@0.1.3 nodebb-plugin-sso-github@2.0.2 nodebb-plugin-sso-twitter@2.3.0 nodebb-plugin-sso-google@2.0.1 nodebb-plugin-sso-facebook@3.0.4 nodebb-plugin-ns-custom-fields@4.0.0 nodebb-plugin-ns-awards-next@4.1.0 nodebb-plugin-google-analytics@0.5.9 nodebb-plugin-iframely@0.6.12"
